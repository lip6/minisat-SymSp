...
MINISAT_REL    ?= -O3 -D NDEBUG -std=c++11
MINISAT_DEB    ?= -O0 -D DEBUG -std=c++11
MINISAT_PRF    ?= -O3 -D NDEBUG -std=c++11
MINISAT_FPIC   ?= -fpic
...
MINISAT_LDFLAGS  = -Wall -lz -lcosy -lbliss
...
$(BUILD_DIR)/profile/%.o:			MINISAT_CXXFLAGS +=$(MINISAT_PRF) /data/hmetin/gperftools/build/lib/libtcmalloc_and_profiler.a
